...
class Student(models.Model):
    ...
    second_name = models.CharField(_('second name'), max_length=50, null=True, default=None)
    ...
    phone_parents = models.CharField(_('number phone parents'), max_length=15, null=True, default=None)
